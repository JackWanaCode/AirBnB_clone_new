$(document).ready(function () {
  ...
  function get_place(dict) {
    $.ajax({
      url: 'http://35.231.97.140:8002/api/v1/places_search/',
      dataType: 'json',
      type: 'post',
      ...
      success: function( data, textStatus, jQxhr ){
        ...
        for (let i in data) {
          let d = data[i];
          let user_url = 'http://35.231.97.140:8002/api/v1/users/' + d.user_id;
          let review_url = 'http://35.231.97.140:8002/api/v1/places/' + d.id + '/reviews';
          let ame_url = 'http://35.231.97.140:8002/api/v1/places/' + d.id + '/amenities';
          $.when($.ajax(user_url), $.ajax(review_url), $.ajax(ame_url)).done(function(user_d, review_d, ame_d) {
            ...
            review_d[0].forEach(rev => {
              review_arr.push(new Promise((resolve, reject) => {
                ...
                let review_user_id_url = 'http://35.231.97.140:8002/api/v1/users/' + rev.user_id;
